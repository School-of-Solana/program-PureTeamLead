...
var ICONS = {
  add: async () => (await import("./add-NKOWG2VR.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-RULSCWH4.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-2SIYVIR5.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-72UCYYUB.js")).appStoreSvg,
  apple: async () => (await import("./apple-5M3YTAKV.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-HFB6JBDH.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-6U77JO6Z.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-PM3BKRCZ.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-HRE6VGY7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-UWYEH3AE.js")).bankSvg,
  browser: async () => (await import("./browser-BOLFEDE2.js")).browserSvg,
  card: async () => (await import("./card-NLE5ZMWI.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-7NNFYBOJ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-GONKSAD6.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-2FJAAOTM.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-IFJPHXBX.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-NDACWY5W.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-6YOMCIPI.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-PDVJOK3J.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ELBZMG2C.js")).clockSvg,
  close: async () => (await import("./close-AZFZQ5A5.js")).closeSvg,
  compass: async () => (await import("./compass-BZL4BWRS.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-467D2LZD.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-NSJO6KZ7.js")).copySvg,
  cursor: async () => (await import("./cursor-NOCGYJCT.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-2NWLNFJP.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-QJAIOTLN.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-YQSNJW26.js")).disconnectSvg,
  discord: async () => (await import("./discord-WSPM53C4.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-QAVXKQ3L.js")).etherscanSvg,
  extension: async () => (await import("./extension-GDUMTLWS.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-VFHS26W2.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HYTMTTE3.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ZERN2EKG.js")).farcasterSvg,
  filters: async () => (await import("./filters-A5IFJGEF.js")).filtersSvg,
  github: async () => (await import("./github-ATKE23XD.js")).githubSvg,
  google: async () => (await import("./google-C2WHOIQ7.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-PXMM7RAX.js")).helpCircleSvg,
  image: async () => (await import("./image-C4GG3Z7A.js")).imageSvg,
  id: async () => (await import("./id-QHIBPJQU.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-THZISANL.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-VS3PUGZF.js")).lightbulbSvg,
  mail: async () => (await import("./mail-LVMD7F56.js")).mailSvg,
  mobile: async () => (await import("./mobile-Y2527QYH.js")).mobileSvg,
  more: async () => (await import("./more-4BUTPGGK.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-SFGS4A2A.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-JKJATBDY.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-NTFWI3KO.js")).offSvg,
  playStore: async () => (await import("./play-store-7WLLUNK5.js")).playStoreSvg,
  plus: async () => (await import("./plus-L4FELNTP.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-YTP57I5D.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-NNZQBQ6J.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-S7SDDM7C.js")).refreshSvg,
  search: async () => (await import("./search-FW4KOIPJ.js")).searchSvg,
  send: async () => (await import("./send-5YI263CS.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-FQZPFQP4.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-BEBQZ5ZS.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-UVMP67OA.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-FSERXXPP.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-EPCEQGVX.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-33TRJZON.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-X43AAVAZ.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-DBDQI25H.js")).twitchSvg,
  twitter: async () => (await import("./x-ZKHI6V3G.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-VR73K7PB.js")).twitterIconSvg,
  verify: async () => (await import("./verify-KKDOHN23.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-DGNWZQBE.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-IJAAIZBN.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-X7QML3V7.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-X7QML3V7.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-X7QML3V7.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-SQSL4HZY.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-WOUTOV5D.js")).warningCircleSvg,
  x: async () => (await import("./x-ZKHI6V3G.js")).xSvg,
  info: async () => (await import("./info-RSHQCAUP.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-XDBZNSHR.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-GRKFX7QR.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-V2GUVFZL.js.map
