...
import { SUBSCRIPTION_CHAIN_PROGRAM_ADDRESS } from '../programs';
...
export type GreetInstruction<
  TProgram extends string = typeof SUBSCRIPTION_CHAIN_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof SUBSCRIPTION_CHAIN_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? SUBSCRIPTION_CHAIN_PROGRAM_ADDRESS;
